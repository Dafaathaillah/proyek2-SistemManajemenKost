                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <select class="form-control" name="month[]" id="choices-month" multiple>
                                <option {{ $details->contains('month', 'Januari 2021') ? 'selected' : '' }}>Januari 2021</option>
                                <option {{ $details->contains('month', 'Februari 2021') ? 'selected' : '' }}>Februari 2021</option>
                                <option {{ $details->contains('month', 'Maret 2021') ? 'selected' : '' }}>Maret 2021</option>
                                <option {{ $details->contains('month', 'April 2021') ? 'selected' : '' }}>April 2021</option>
                                <option {{ $details->contains('month', 'Mei 2021') ? 'selected' : '' }}>Mei 2021</option>
                                <option {{ $details->contains('month', 'Juni 2021') ? 'selected' : '' }}>Juni 2021</option>
                                <option {{ $details->contains('month', 'Juli 2021') ? 'selected' : '' }}>Juli 2021</option>
                                <option {{ $details->contains('month', 'Agustus 2021') ? 'selected' : '' }}>Agustus 2021</option>
                                <option {{ $details->contains('month', 'September 2021') ? 'selected' : '' }}>September 2021</option>
                                <option {{ $details->contains('month', 'Oktober 2021') ? 'selected' : '' }}>Oktober 2021</option>
                                <option {{ $details->contains('month', 'November 2021') ? 'selected' : '' }}>November 2021</option>
                                <option {{ $details->contains('month', 'Desember 2021') ? 'selected' : '' }}>Desember 2021</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-4">
